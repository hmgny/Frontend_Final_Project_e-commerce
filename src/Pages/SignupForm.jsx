...
import { setRoles, setSelectedRole, setFetchState, setLoading } from '../store/actions/clientActions';
...
const SignupForm = () => {
  ...
  const { roles, selectedRole, fetchState, loading } = useSelector(state => state.client);
